...
def isomer(id_galaxy, ra_galaxy, dec_galaxy, z_spec_galaxy, cluster_mass, cluster_initial_redshift, input_H, input_Omega_L, input_Omega_m):
    ...
    This function was developed by P. Cerulo (08/06/2016)
    ...
    r200 = utils.calc_radius_finn(cluster_mass, cluster_initial_redshift, input_H, input_Omega_L, input_Omega_m, "meters")
